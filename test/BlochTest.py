...
class BlochTest(unittest.TestCase):
    ...
    def test_bloch_sim_demo(self):
        ...
        mx, my, mz = sim(b1, g, dt, t1, t2, df, dp, mode, mx_0, mx_0, mx_0)
    ...
    def test_bloch_sim_a(self):
        ...
        mx, my, mz = sim(b1, g, dt, t1, t2, df, dp, mode, mx_0, my_0, mz_0)
    ...
    def test_ssfptransiest(self):
        ...
        mxss, myss, mzss = sim(b1, 0*b1, t, T1, T2, freq, 0, 1)

        mx, my, mz = sim(1.0j * np.max(b1)/2, 0, Trf, T1, T2, freq, 0, 0)

        for _ in range(N):
            mx, my, mz = sim(b1, 0*b1, t, T1, T2, freq, 0, 0, mx, my, mz)
